                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            <figure className="max-w-[200px] max-h-[200px]">
                                <img src="/assets/images/doctor-img02.png" alt="" />
                            </figure>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-[6px]">
                                    <span className="flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 
                                        ...
                                        <img src="/assets/images/Star.png" alt="" /> 4.8
                                    </span>
                        ...
                        <div className="mt-[50px] border-b border-solid border-[#0066ff34]">
                            <button
                                ...
                                className={`${tab === 'about' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 
                            ...
                            <button
                                ...
                                className={`${tab === 'feedback' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5
                                            text-[16px] leading-7 text-headingColor font-semibold`}
                            >
                                Feedback
                            </button>
